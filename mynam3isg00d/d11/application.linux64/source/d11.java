...
public class d11 extends PApplet {
...
public void draw() {
  ...
  for(int i=0; i<squids.length; i++) {
    for(int j=0; j<squids[0].length; j++) {
      ...
      circle((i+0.5f) * width/squids.length, (j+0.5f) * height/squids.length, calcVal(squids[j][i]) * 120);
    }
  }
...
public int update(int i, int j) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "d11" };
    if (passedArgs != null) {
